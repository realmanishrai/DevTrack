  ...
  return (
    <tr className="mb-member-row">
        ...
        <div className="mb-member-row__user-info">
          ...
          <div className="mb-member-row__details">
            <span className="mb-member-row__name">
              {name}{' '}
              {isSelf && (
                <span className="mb-member-row__you-badge">
                  (You)
                </span>
              )}
            </span>

            <span className="mb-member-row__username">
              @{username}
            </span>
          </div>
        </div>
      ...
      <td className="mb-member-row__cell mb-member-row__cell--status">
        <span className="mb-member-row__last-seen">
           {lastSeen}
        </span>
      </td>
      ...
      {isAdmin && (
        <td
          className="mb-member-row__cell mb-member-row__cell--actions"
          ref={actionsRef}
        >
          {!isSelf && (
